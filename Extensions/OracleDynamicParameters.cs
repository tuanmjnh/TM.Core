...
namespace Dapper.Oracle {
    public class OracleDynamicParameters : Dapper.SqlMapper.IDynamicParameters {
        ...
        public OracleDynamicParameters(string refCursor) {
            if (refCursor != null)
                Add(refCursor, dbType : OracleDbType.RefCursor, direction : System.Data.ParameterDirection.Output);
        }
